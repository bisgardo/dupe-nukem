...
class Dir {
     ...
     * @param {HTMLElement} dom DOM element of the directory.
     */
...
class File {
     ...
     * @param {HTMLElement} dom DOM element of the file.
     */
...
function makeTargetDir(parent, scanDir) {
    const dom = document.createElement('custom-dir')
    dom.setAttribute('name', scanDir.name)
    parent?.dom.appendChild(dom) // attach to parent's container DOM element
...
function makeTargetFile(dir, scanFile) {
    const dom = document.createElement('custom-file')
    dom.setAttribute('name', scanFile.name)
    dir.dom.appendChild(dom) // attach to parent's container DOM element
