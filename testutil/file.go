...
// TempFile creates a temporary file with
// the provided contents and returns its path.
// The file is automatically deleted once the test finishes.
func TempFile(t *testing.T, contents string) string {
	return TempFileByPattern(t, "", contents)
}
...
// The file is automatically deleted once the test finishes.
func TempFileByPattern(t *testing.T, pattern, contents string) string {
