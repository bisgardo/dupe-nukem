...
Match files in source directory against all provided target directories.
Outputs a match file which links the hash of all matched files in source to the corresponding paths in the targets.
